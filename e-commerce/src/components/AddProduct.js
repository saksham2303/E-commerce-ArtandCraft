...
function combine(e){
  ...
  handleimagechange(e)
    ...
    function handleClick(e){
      ...
      //   productprice
      // }
      console.log(form_data.get("productimage"))
      const request_config = {
        method: "post",
        url: "http://localhost:5001/uploadproduct",
        headers: {
  ...
  <div className="Choose__file">
            ...
            <input name='productimage' type="file" id="inpFile" className="inpFile" onChange={combine}  />
  ...
  <div className="Choose__file">
  <ReactBootstrap.Form.Label>Author Name</ReactBootstrap.Form.Label>
